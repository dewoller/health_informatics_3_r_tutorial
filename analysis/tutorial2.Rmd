...
```
The data from the above queries are in a zip file. [Download cardiac.zip](assets/cardiac.zip) to your desktop.  It contains these two datasets as csv files, cardiac_diagnosis.csv and cardiac_procedures.csv. 
