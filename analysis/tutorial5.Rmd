...
1.  The header section, setting up the entire document.
...
To run the code in a section, click on the left hand arrow, or press *ctrl-shift-enter*.  To view the entire resulting document, press the `preview` button.  

### Exercises
1. Press the preview button.   Note how the code transforms into a figure.
...
To start, we load the libraries and query the databases, accessing the same cardiac procedures and diagnosis data we used in the above tutorial.
