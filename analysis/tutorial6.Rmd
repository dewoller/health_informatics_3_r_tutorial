...
Let's separate out the people who died.  About 10% of patients with this diagnosis die.

We exclude some columns that are not useful for the predictions (position, diag_code, diag_short_desc), and also, exclude columns that would make the prediction too easy (sep_mode_id and sep_mode_desc)
