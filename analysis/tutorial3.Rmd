...
To import data from Excel, first, we need some Excel data. [assets/excel-datasheets/myhospitals-average-length-of-stay-data.xlsx] (Here is an Excel dataset containing hospital length of stay data).  Download it and then upload it to Rstudio server.
